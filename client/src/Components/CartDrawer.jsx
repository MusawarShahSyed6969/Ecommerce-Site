...
const CartDrawer = ({setisDrawerOpen,isDrawerOpen}) => {
  const navigate = useNavigate();
    ...
    return (
        <div className={`bg-bg-secondary flex flex-col transition-all ease-in duration-300 fixed top-0 right-0 z-50 h-full min-h-full w-80 ${isDrawerOpen ? 'translate-x-0' : 'translate-x-full'}`}>
