...
export default function OrdersPanel() {
    ...
    const filteredOrders = ordersData.filter((order) => {
        const matchesFilter =
            ...
            (selectedFilter === "pending" && order.orderStatus !== "Delivered");
            ...
            <div className="flex gap-2 flex-wrap" style={{ marginBottom: "16px" }}>
                {filters.map((filter) => (
                    <button
                        ...
                        className={`rounded ${selectedFilter === filter ? "bg-blue-500 text-white" : "bg-gray-200"}`}
            ...
            >
                {filteredOrders.map((order) => (
                    ...
                    >
                        {/* Product Image */}
                        <div
                            className="w-full h-48 overflow-hidden rounded-md flex justify-center items-center"
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 items-center" style={{ marginBottom: "16px" }}>
                            <div
                                className="w-full sm:w-1/3 h-40 overflow-hidden rounded-md flex justify-center items-center"
                                style={{ marginBottom: "16px" }}
                            >
                                <img
